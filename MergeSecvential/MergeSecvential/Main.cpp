...
int main() {
    ...
    int sizes[] = { 1000000, 2500000, 5000000,7500000,10000000, 12500000 };
    string filenames[] = { "data_1000000.txt", "data_2500000.txt", "data_5000000.txt", "data_7500000.txt","data_10000000.txt","data_12500000.txt" };
